...
export default function PrimaryCalloutCard({ label, value, valueStyle = "green" }: CalloutCardProps) {
  return (
    <div className={`${inter.className} bg-[#f5f5f5] rounded-xl py-4 px-6 w-auto inline-block h-auto`}>
